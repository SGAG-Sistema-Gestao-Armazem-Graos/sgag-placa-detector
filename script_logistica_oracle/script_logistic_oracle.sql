-- Criação da tabela VehicleLoadType
BEGIN
...
-- Criação da tabela ResponsiblePerson
BEGIN
...
-- Criação da tabela LoadGrainType
BEGIN
...
-- Criação da tabela WeatherForecast
BEGIN
...
CREATE TABLE WeatherForecast (
  ...
  temperature NUMBER(3) NOT NULL, -- aceita valores negativos
  humidity NUMBER(3) NOT NULL -- percentual (0 a 100)
);

-- Criação da tabela Movement
BEGIN
...
-- Criação dos índices auxiliares
...
-- Criação da tabela MovementForecast
BEGIN
...
-- Criação da tabela StockHistory
BEGIN
